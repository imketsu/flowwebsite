...
export function DownloadSection() {
  return (
    <section id="download-section" className="py-16 bg-black/20">
      <div className="container mx-auto px-4">
        <h2 className="text-center text-2xl font-semibold mb-12 text-muted-foreground">Download for...</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
          <Card
            className="relative overflow-hidden bg-gradient-to-br from-card/90 to-card/50 backdrop-blur-sm border-border/50 hover:border-primary/50 transition-all duration-300 group cursor-pointer"
            onClick={() => window.open("https://gofile.io/d/your-file-id", "_blank")}
          >
